...
OOption n_psOptions[] =
	{
		...
		{ "lower-bound-x", D_DOUBLE_LONG, &setup.f_dLowerBoundX, "[", OOption::D_REQUIRED, "val", "set lower bound for interval on X axis to val", NULL },
		{ "upper-bound-x", D_DOUBLE_LONG, &setup.f_dUpperBoundX, "]", OOption::D_REQUIRED, "val", "set upper bound for interval on X axis to val", NULL },
		{ "lower-bound-y", D_DOUBLE_LONG, &setup.f_dLowerBoundY, "{", OOption::D_REQUIRED, "val", "set lower bound for interval on Y axis to val", NULL },
		{ "upper-bound-y", D_DOUBLE_LONG, &setup.f_dUpperBoundY, "}", OOption::D_REQUIRED, "val", "set upper bound for interval on Y axis to val", NULL },
